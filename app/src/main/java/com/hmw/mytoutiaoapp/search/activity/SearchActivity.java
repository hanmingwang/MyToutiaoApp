package com.hmw.mytoutiaoapp.search.activity;
...
import com.hmw.mytoutiaoapp.base.BasePagerAdapter;
import com.hmw.mytoutiaoapp.config.Constant;
import com.hmw.mytoutiaoapp.database.dao.SearchHistoryDao;
import com.hmw.mytoutiaoapp.net.RetrofitFactory;
import com.hmw.mytoutiaoapp.net.api.IMobileSearchApi;
import com.hmw.mytoutiaoapp.search.bean.SearchHistoryBean;
import com.hmw.mytoutiaoapp.search.bean.SearchRecommentBean;
import com.hmw.mytoutiaoapp.search.adapter.SearchHistoryAdapter;
import com.hmw.mytoutiaoapp.search.adapter.SearchSuggestionAdapter;
import com.hmw.mytoutiaoapp.search.mvp.SearchResultFragment;
...
public class SearchActivity extends BaseActivity implements View.OnClickListener {
    ...
    //输入框中输入关键字 动态显示提示条
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {//进入界面时就执行
